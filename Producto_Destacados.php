...
<body>
    ...
    <header class="header">
            ...
            <img src="img/sda.png" alt="Logotipo">  
            <h2 class="Nombre_Empresa">Tucalzado</h2>
            </a>
    ...
    <nav class="navegacion">
        <a class="navegacion__enlace--activo" href="Producto_Destacados.php">Producto Destacados</a>
    ...
    <footer class="footer">
        <p class="footer__texto">Tucalzado.com - Todos los derechos Reservados 2024.</p>
    </footer>
</body>
</html>
</html>